...
import { createCourse, createLecture, editCourse, editLecture, getCourseById, getCourseLecture, getCreatorCourses, getLectureById, getPublishedCourses, removeCourse, removeLecture, searchCourse, toggleCoursePublish, unenrollStudent } from '../controllers/course.controller.js';
...
router.route("/:courseId/student/:studentId").delete(isAuthenticated, unenrollStudent);

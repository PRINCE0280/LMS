...
import { useGetQuizQuery, useUpdateQuizMutation, useGetCourseStudentsQuery } from '@/features/api/quizApi';
  ...
  useEffect(() => {
    if (quizData?.quiz) {
      ...
      setFormData({
        ...
        selectedUsers: quiz.selectedUsers?.map(u => u._id || u) || [],
        selectedCourses: quiz.selectedCourses?.map(c => c._id || c) || [],
      });
